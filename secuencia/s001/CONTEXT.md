...
Agrega al proyecto un archivo especificando que la licencia será Creative Commons tal como lo indicado en el archivo LICENSE
...
Se creará y mantendrá actualizado en la medida que se agreguen funciones un workflow de validación en Github implementado mediante actions consistente en
